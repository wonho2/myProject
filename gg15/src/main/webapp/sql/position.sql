...
(
    ...
    mem_num NUMBER FOREIGN KEY REFERENCES member(mem_num) NOT NULL, /*작성자(회원) 고유번호 <foreign : member>*/
...
(
    ...
    pos_num NUMBER FOREIGN KEY REFERENCES position(pos_num) NOT NULL, /*해당 댓글이 소속된 게시물 고유번호 <foreign : position>*/
    mem_num NUMBER FOREIGN KEY REFERENCES member(mem_num) NOT NULL, /*댓글 작성자(회원) 고유번호 <foreign : member>*/
...
(
    ...
    pos_num NUMBER FOREIGN KEY REFERENCES position(pos_num) NOT NULL, /*게시물 고유번호 <foreign : position>*/
    mem_num NUMBER FOREIGN KEY REFERENCES member(mem_num) NOT NULL, /*추천한 회원 고유번호 <foreign : member>*/)
);
...
(
    ...
    por_num NUMBER FOREIGN KEY REFERENCES position_comment(poc_num), /*댓글 고유번호 <foreign : position_comment>*/
    mem_num NUMBER FOREIGN KEY REFERENCES member(mem_num) NOT NULL, /*추천한 회원 고유번호 <foreign : member>*/
);
